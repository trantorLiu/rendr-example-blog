...
}, "app/collections/posts": function(exports, require, module) {var Post = require('../models/post')
  , Base = require('./base');
...
}, "app/controllers/posts_controller": function(exports, require, module) {module.exports = {
...
module.exports = RendrBase.extend({});
}, "app/models/post": function(exports, require, module) {var Base = require('./base');
...
}, "app/views/posts_add_view": function(exports, require, module) {var BaseView = require('./base_view'),
...
}, "app/views/posts_del_view": function(exports, require, module) {var BaseView = require('./base_view');
...
}, "app/views/posts_edit_view": function(exports, require, module) {var BaseView = require('./base_view');

module.exports = BaseView.extend({
  className: 'posts_edit_view'
});
module.exports.id = 'PostsEditView';
}, "app/views/posts_index_view": function(exports, require, module) {var BaseView = require('./base_view');

module.exports = BaseView.extend({
  className: 'posts_index_view'
});
module.exports.id = 'postsIndexView';
}, "app/views/posts_show_view": function(exports, require, module) {var BaseView = require('./base_view');

module.exports = BaseView.extend({
  className: 'posts_show_view'
});
module.exports.id = 'PostsShowView';
  ...
  serverSync = function(method, model, options) {
    ...
    return server.dataAdapter.request(this.app.req, api, function(err, response, body) {
      if (err) {
        if (!_.isObject(body)) {
          body = {
            body: body
  ...
  var func, handlebarsHelpers, key, templates,
    __hasProp = {}.hasOwnProperty;
